...
export default function SideBar() {
  ...
  return (
    <div className={` w-full  flex-col items-center justify-center md:col-span-4 md:flex hidden h-auto relative   `}>
      ...
      <div className={` side-content-box w-full h-auto lg:mt-[6.5rem] mt-[4.5rem] rounded-[1.25rem] pt-[5.125rem] lg:pt-[7.125rem] pb-[3.75rem] ${toggleDark ? 'dark-bg' : 'light-bg'} overflow-hidden `}>
        ...
        <div className={` details-box w-full lg:p-[1.5rem] p-3  gap-4   ${toggleDark ? 'dark-bg' : 'light-bg'} `}>
